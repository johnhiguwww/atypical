...
Class Crianca{
    ...
    public function cadastrarCrianca($nome_crianca, $email_crianca, $senha_crianca, $deficiencia,$genero, $data_nascimento, $comportamentos_inadequados, $interacao_social, $esteriotipia, $comunica_varbalmente, $link_hiperco,  $link_hiperco2,  $link_hiperco3, $motora_fina, $motora_grossa, $firmou_cabeca, $sentou_apoio, $engatinhou, $andou_anos, $tropeca_andar, $escada_alternado, $linha_reta, $pula_pe_so, $dificuldade_aprendizagem, $materias_escolares, $tdh , $prenatal, $dores_parto, $doenca_gestacao, $gestacao_risco, $gestacao_medicamento, $crianca_nascimento, $demostra_carinho, $carinho_pessoa, $interesses_crianca, $brinca_sozinha, $descricao_socializacao, $compartilha_objeto, $identifica_sentimentos, $demostra_empatia, $comportamentos_frustracoes, $sialorreia, $tosse_engasgo_alimentacao ,$dificuldade_comunicacao, $alimentacao_consistencia ,$ecolalias_tardias_imediatas , $contato_ocular_pessoas , $demora_de_fala ,$dificuldade_de_brinca, $dificuldade_de_brinca_com_pessoas, $ingere_medicamentos)
    {
        ...
        {
            $cmd = $this->pdo->prepare("INSERT INTO crianca (nome_crianca, email_crianca, senha_crianca, deficiencia,genero, data_nascimento, comportamentos_inadequados, interacao_social, esteriotipia, comunica_varbalmente, link_hiperco,  link_hiperco2,  link_hiperco3, motora_fina, motora_grossa, firmou_cabeca, sentou_apoio, engatinhou, andou_anos, tropeca_andar, escada_alternado, linha_reta, pula_pe_so, dificuldade_aprendizagem, materias_escolares, tdh , prenatal, dores_parto, doenca_gestacao, gestacao_risco, gestacao_medicamento, crianca_nascimento, demostra_carinho, carinho_pessoa, interesses_crianca, brinca_sozinha, brinca_outras_crianca, descricao_socializacao, compartilha_objeto, identifica_sentimentos, demostra_empatia, comportamentos_frustracoes, sialorreia, tosse_engasgo_alimentacao ,dificuldade_comunicacao, alimentacao_consistencia ,ecolalias_tardias_imediatas , contato_ocular_pessoas , demora_de_fala ,dificuldade_de_brinca, dificuldade_de_brinca_com_pessoas, ingere_medicamentos)
             VALUES (:n,:e,:s,:d,:g,:dn,:ci,:il,:et,:cv,:lk,:lk2,:lk3,:mf,:mg,:fc,:sa,:en,:aa,:ta,:ea,:lr,:pp,:da,:me,:thd,:pn,:dp,:dg,:gr,:gm,:cn,:dc,:cp,:ic,:bs,:ds,:co,:ids,:de,:cf,:si,:ta,:dc,:ac,:ei,:cp,:df,:db,:dbp,:im)");
            ...
            $cmd->bindValue(":ci",$comportamentos_inadequados);
            $cmd->bindValue(":il",$interacao_social);
            $cmd->bindValue(":et",$esteriotipia);
            $cmd->bindValue(":cv",$comunica_varbalmente);
            $cmd->bindValue(":lk",$link_hiperco);
            $cmd->bindValue(":lk2",$link_hiperco2);
            $cmd->bindValue(":lk3",$link_hiperco3);
            ...
            $cmd->bindValue(":dc",$demostra_carinho);
            ...
            $cmd->bindValue(":de",$demostra_empatia);
            ...
            $cmd->bindValue(":im",$ingere_medicamentos);
            $cmd->execute();
            return true;
        }
    }
