...
<body>
    ...
    $email_crianca = addslashes($_POST['email_terapeuta']);
    $senha_crianca = addslashes($_POST['senha_crianca']);
    $deficiencia = addslashes($_POST['deficiencia']);
    $genero = addslashes($_POST['genero']);
    $data_nascimento = addslashes($_POST['data_nascimento']);
    $comportamentos_inadequados = addslashes($_POST['comportamentos_inadequados']);
    $interacao_social = addslashes($_POST['interacao_social']);
    $esteriotipia = addslashes($_POST['esteriotipia']);
    $comunica_varbalmente = addslashes($_POST['comunica_varbalmente']);
    $link_hiperco = addslashes($_POST['link_hiperco']);
    $link_hiperco2 = addslashes($_POST['link_hiperco2']);
    $link_hiperco3 = addslashes($_POST['link_hiperco3']);
    ...
    $demostra_carinho = addslashes($_POST['demostra_carinho']);
    ...
    $demostra_empatia = addslashes($_POST['demostra_empatia']);
    ...
    $ingere_medicamentos = addslashes($_POST['ingere_medicamentos']);

    if(!empty($nome_crianca) && !empty($email_crianca) && !empty($senha_crianca) && !empty($deficiencia))
    {
        if(!$p->cadastrarCrianca($nome_crianca, $email_crianca, $senha_crianca, $deficiencia,$genero, $data_nascimento,$comportamentos_inadequados,$interacao_social,$esteriotipia,$comunica_varbalmente,$link_hiperco,$link_hiperco2,$link_hiperco3,$motora_fina,$motora_grossa,$firmou_cabeca,$sentou_apoio,$engatinhou,$andou_anos,$tropeca_andar,$escada_alternado, $linha_reta,$pula_pe_so,$dificuldade_aprendizagem,$materias_escolares,$tdh,$prenatal,$dores_parto,$doenca_gestacao,$gestacao_risco,$gestacao_medicamento,$crianca_nascimento,$demostra_carinho,$carinho_pessoa,$interesses_crianca, $brinca_sozinha,$descricao_socializacao,$compartilha_objeto,$identifica_sentimentos,$demostra_empatia,$comportamentos_frustracoes,$sialorreia,$tosse_engasgo_alimentacao,$dificuldade_comunicacao,$alimentacao_consistencia,$ecolalias_tardias_imediatas,$contato_ocular_pessoas,$demora_de_fala,$dificuldade_de_brinca,$dificuldade_de_brinca_com_pessoas,$ingere_medicamentos))
        {
        ...
        <form action="./crianca.php" method="POST">
            <fieldset>
                ...
                <div class="inputBox">
                    ...
                    <label for="nome_crianca" class="labelInput">Nome completo</label>
                </div>
                <br><br>
                <div class="inputBox">
                ...
                <input type="checkbox" name="comportamento_inadequados" id="comportamento_inadequados">
                </label> <br>
                </div>
                <br>
                <div class="inputBox">
                ...
                <input type="checkbox" name="interacao_social" id="interacao_social">
                </label> 
                </div>
                <br>
                <div class="inputBox">
                <label>
                 ...
                 <input type="checkbox" name="esteriotipia" id="esteriotipia">
                </label>
                <div class="inputBox">
                  <br>    
                <label>
                 A criança se comunica verbalmente?
                 <input type="checkbox" name="comunica_verbalmente" id="comunica_verbalmente">            
                </label> <br>
                <br>
                <div class="inputBox">
                    <h3>Hiperfoco:</h3>
                  ...
                  <label>
                      ...
                      <input type="text" name="links_hiperfoco3" id="links_hiperfoco3" />                    
                            ...
                            *por exemplo pegada de lápis e talheres*
                            <br>
                            <input type="checkbox" name="motora_fina" id="motora_fina">
                            </label> <br><br>
                            <label>
                                A criança tem dificuldade motora grossa? <br>
                                *por exemplo deficuldade em andar*
                                <br>
                                <input type="checkbox" name="motora_grossa" id="motora_grossa">
                                </label><br>
                                <h3>Aprendizagem</h3>
                                <label>
                                    A criança tem dificuldade de aprendizagem?
                                    <input type="checkbox" name="deficuldade_aprendizagem" id="deficuldade_aprendizagem">
                               </label> <br><br>
                               <label>
                                   ...
                                   <label>
                                       ...
                                       <input type="checkbox" name="doenca_gestacao" id="doenca_gestacao">
                                       <br>
                                       Foi de risco?
                                       <input type="checkbox" name="gestacao_risco" id="gestacao_risco">
                                       <br>
                                       Fez uso de medicamentos?
                                       <input type="checkbox" name="gestacao_medicamento" id="gestacao_medicamento">
                                       <br><br>
                                   ...
                                   <br><br>
                                   Engatinhou?
                                   <input type="checkbox" name="engatinhou" id="engatinhou">
                                   <br><br>
                                   Andou com quantos anos? 
                                   <input type="text" name="andou_anos" id="andou_anos">
                                   <br><br>
                                   Tropeça muito ao andar?
                                   <input type="checkbox" name="tropeca_andar" id="tropeca_andar">
                                   <br><br>
                                   Sobe escada alternado?
                                   <input type="checkbox" name="escada_alternado" id="escada_alternado">
                                   <br><br>
                                   Anda em linha reta? 
                                   <input type="checkbox" name="linha_reta" id="linha_reta">
                                   <br><br>
                                   Pula de um pé só?
                                   <input type="checkbox" name="pula_pe_so" id="pula_pe_so"> 
                                   <br><br>
                                   ...
                                   <label>
                                     ...
                                     <input type="checkbox" name="brinca_sozinha" id="brinca_sozinha">
                                     <br><br>
                                     ...
                                     <br><br>
                                     Compartilha objetos? 
                                     <input type="checkbox" name="compartilha_objeto" id="compartilha_objeto">
                                     <br><br>
                                     A criança identifica sentimentos? 
                                     <input type="checkbox" name="identifica_sentimentos" id="identifica_sentimentos">
                                     <br><br>
                                     Demonstra empatia (ex.: fica triste ao ver o outro triste)? 
                                    <input type="checkbox" name="demostra_empatia" id="demostra_empatia">
                                    <br><br>
                      ...
                      <label>
                          ...
                          <input type="checkbox" name="dificuldadedefala" id="dificuldadedefala">
                        </label> <br><br>
                        <label>
                            A criança tem dificuldade de mastigar?
                            <input type="checkbox" name="dificuldadedemastigar" id="dificuldadedemastigar">
                           </label> <br><br>
                           A criança apresenta sialorreia? (salivação em excesso) 
                           <input type="checkbox" name="sialorreia" id="sialorreia">
                           <label> <br><br>
                           <label>
                           A criança apresenta tosse ou engasgo quando se alimenta?
                           <input type="checkbox" name="tosse_engasgo_alimentacao" id="tosse_engasgo_alimentacao"> 
                           <label> <br><br>
                           <label>
                           A criança apresenta dificuldade para se comunicar ( não usa gestos ou fala)?         
                           <input type="checkbox" name="dificuldade_comunicacao" id="dificuldade_comunicacao">
                           <label> <br><br>
                           <label>
                           A criança se alimenta de todas as consistência ( líquido, pastoso e sólido)?
                           <input type="checkbox" name="alimentacao_consistencia" id="alimentacao_consistencia">
                           <label> <br><br>
                           <label>
                           A criança apresenta ecolalias tardias ou imediatas (repetir falas das pessoas ou de desenhos animados)?
                           <input type="checkbox" name="ecolalias_tardias_imediatas" id="ecolalias_tardias_imediatas">
                           <label> <br><br>
                           <label>
                           A criança tem dificuldade de olhar ou manter o contato ocular com as pessoas? 
                           <input type="checkbox" name="contato_ocular_pessoas" id="contato_ocular_pessoas">
                           <label> <br><br>
                           <label>
                           A criança demorou a falar ou fala poucas palavras?
                           <input type="checkbox" name="demora_de_fala" id="demora_de_fala">                           <label> <br><br>
                           <label>
                           A criança tem dificuldades no brincar pois, apenas gira os brinquedos ou joga no chão?
                           <input type="checkbox" name="dificuldade_de_brinca" id="dificuldade_de_brinca">
                           <label> <br><br>
                           <label>
                           ...
                           <input type="checkbox" name="dificuldade_de_brinca_com_pessoas" id="dificuldade_de_brinca_com_pessoas">
                           <br><br>
                           <h3>Medicamentos</h3>
                           <label>
